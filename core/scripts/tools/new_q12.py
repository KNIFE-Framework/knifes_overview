...
- Prejsť celý strom šablón v core/templates/content/q12/body (alebo v ceste z configu).
- Pre každý .md súbor:
...
def _resolve_body_root(config: Dict[str, Any]) -> Path:
    """
    Zistí koreňový adresár pre body šablóny Q12.

    Preferuje sa hodnota v config/q12/q12_config.yml, napr.:
      template_body_root: "core/templates/content/q12/body"
    ...
    return Path("core/templates/content/q12/body")
