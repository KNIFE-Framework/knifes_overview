"use strict";
(globalThis["webpackChunkknife_preview"] = globalThis["webpackChunkknife_preview"] || []).push([[24246],{
...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/chunk-CLGD4ZFX.mjs
var chunk_CLGD4ZFX = __webpack_require__(5637);
...
var DEFAULT_VENN_CONFIG = chunk_DU6HZSFF/* defaultConfig_default */.UI.venn;
function getConfig2() {
  return (0,chunk_75Z2AOVW/* cleanAndMerge */.$t)(DEFAULT_VENN_CONFIG, (0,chunk_DU6HZSFF/* getConfig */.zj)().venn);
}
...
var db = {
  ...
  clear: customClear,
  setAccTitle: chunk_DU6HZSFF/* setAccTitle */.SV,
  getAccTitle: chunk_DU6HZSFF/* getAccTitle */.iN,
  setDiagramTitle: chunk_DU6HZSFF/* setDiagramTitle */.ke,
  getDiagramTitle: chunk_DU6HZSFF/* getDiagramTitle */.ab,
  getAccDescription: chunk_DU6HZSFF/* getAccDescription */.m7,
  setAccDescription: chunk_DU6HZSFF/* setAccDescription */.EI,
  addSubsetData,
  getSubsetData,
  addTextData,
  addStyleData,
...
var draw = /* @__PURE__ */ (0,chunk_Y2CYZVJY/* __name */.K)((_text, id, _version, diagObj) => {
  ...
  const { themeVariables, look, handDrawnSeed } = (0,chunk_DU6HZSFF/* getConfig */.zj)();
  ...
  const svg = (0,chunk_CLGD4ZFX/* selectSvgElement */.D)(id);
  ...
  (0,chunk_DU6HZSFF/* configureSvgSize */.a$)(svg, svgHeight, svgWidth, config?.useMaxWidth ?? true);
}, "draw");
