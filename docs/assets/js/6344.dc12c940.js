(globalThis["webpackChunkknife_preview"] = globalThis["webpackChunkknife_preview"] || []).push([[6344],{
...
/* harmony import */ var _chunk_CLGD4ZFX_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5637);
/* harmony import */ var _chunk_GMAD6QVW_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(72379);
/* harmony import */ var _chunk_PWAF6VOD_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(58962);
...
/* harmony import */ var cytoscape__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(90165);
/* harmony import */ var cytoscape_fcose__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(26527);
...
var DEFAULT_ARCHITECTURE_CONFIG = _chunk_DU6HZSFF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .defaultConfig_default */ .UI.architecture;
var ArchitectureDB = class {
  ...
  getConfig() {
    return (0,_chunk_75Z2AOVW_mjs__WEBPACK_IMPORTED_MODULE_4__/* .cleanAndMerge */ .$t)({
      ...DEFAULT_ARCHITECTURE_CONFIG,
      ...(0,_chunk_DU6HZSFF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)().architecture
    });
  }
...
var architectureIcons = {
  ...
  icons: {
    ...
    unknown: _chunk_PWAF6VOD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .unknownIcon */ .Gc,
    blank: {
      body: wrapIcon("")
    }
  }
  ...
  await Promise.all(
    cy.edges().map(async (edge) => {
      ...
      if (edge[0]._private.rscratch) {
        ...
        g.insert("path").attr("d", `M ${startX},${startY} L ${midX},${midY} L${endX},${endY} `).attr("class", "edge").attr("id", `${diagramId}-${(0,_chunk_75Z2AOVW_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getEdgeId */ .rY)(source, target, { prefix: "L" })}`);
        if (sourceArrow) {
        ...
        if (label) {
          ...
          await (0,_chunk_GMAD6QVW_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(
            textElem,
            label,
            {
              useHtmlLabels: false,
            ...
            (0,_chunk_DU6HZSFF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)()
          );
    ...
    cy.nodes().map(async (node) => {
      ...
      if (data.type === "group") {
        ...
        if (data.icon) {
          ...
          bkgElem.html(
            `<g>${await (0,_chunk_PWAF6VOD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getIconSVG */ .WY)(data.icon, { height: groupIconSize, width: groupIconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
          );
          bkgElem.attr(
            "transform",
...
var drawServices = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)(async function(db, elem, services, diagramId) {
  ...
  for (const service of services) {
    ...
    if (service.icon) {
      bkgElem.html(
        `<g>${await (0,_chunk_PWAF6VOD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getIconSVG */ .WY)(service.icon, { height: iconSize, width: iconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
      );
    } else if (service.iconText) {
      bkgElem.html(
        `<g>${await (0,_chunk_PWAF6VOD_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getIconSVG */ .WY)("blank", { height: iconSize, width: iconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
      );
      const textElemContainer = bkgElem.append("g");
      const fo = textElemContainer.append("foreignObject").attr("width", iconSize).attr("height", iconSize);
      const divElem = fo.append("div").attr("class", "node-icon-text").attr("style", `height: ${iconSize}px;`).append("div").html((0,_chunk_DU6HZSFF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .sanitizeText */ .jZ)(service.iconText, config));
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)(async (text, id, _version, diagObj) => {
  ...
  positionNodes(db, cy);
  (0,_chunk_DU6HZSFF_mjs__WEBPACK_IMPORTED_MODULE_5__/* .setupGraphViewbox */ .ot)(void 0, svg, db.getConfigField("padding"), db.getConfigField("useMaxWidth"));
}, "draw");
var renderer = { draw };
