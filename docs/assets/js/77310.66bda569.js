"use strict";
(globalThis["webpackChunkknife_preview"] = globalThis["webpackChunkknife_preview"] || []).push([[77310],{
...
/* harmony export */ });
/* harmony import */ var _chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5691);
/* harmony import */ var _chunk_L3NEJ4N5_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(24980);
/* harmony import */ var _chunk_OSK3NFVY_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(27838);
/* harmony import */ var _chunk_GVQU2GXP_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(96865);
/* harmony import */ var _chunk_4HAMMTFA_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(48159);
/* harmony import */ var _chunk_P2QGCYS3_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(44505);
/* harmony import */ var _chunk_GMAD6QVW_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(72379);
/* harmony import */ var _chunk_PWAF6VOD_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(58962);
/* harmony import */ var _chunk_75Z2AOVW_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(16459);
/* harmony import */ var _chunk_DU6HZSFF_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(76385);
/* harmony import */ var _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(31293);
/* harmony import */ var _chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(86827);
/* harmony import */ var dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(73765);
...
var measureDagreGraph = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K)(async ({
  ...
  const {
    ...
    nodes,
    rootGroups: elem
  } = (0,_chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .createLayoutElementGroups */ .B)(_elem, {
  ...
  await Promise.all(
    graph.nodes().map(async function(v) {
      ...
      if (node?.clusterNode) {
        ...
        const newEl = o.elem;
        (0,_chunk_4HAMMTFA_mjs__WEBPACK_IMPORTED_MODULE_4__/* .updateNodeBounds */ .lC)(node, newEl);
        node.diff = o.diff || 0;
        ...
        (0,_chunk_GVQU2GXP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .setNodeElem */ .U7)(newEl, node);
      } else {
        if (graph.children(v).length > 0) {
          ...
          _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .R.trace((0,_chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .findNonClusterChild */ .dc)(node.id, graph));
          _chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clusterDb */ .ju.set(node.id, { id: (0,_chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .findNonClusterChild */ .dc)(node.id, graph), node });
        } else {
          _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .R.trace("Node - the non recursive path XAX", v, nodes, graph.node(v), dir);
          await (0,_chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertMeasuredNode */ .sv)(nodes, graph.node(v), { config: siteConfig, dir });
        }
      }
    })
  );
  const processEdges = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K)(async () => {
    const edgePromises = graph.edges().map(async function(e) {
      ...
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .R.info(
        "Fix",
        _chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clusterDb */ .ju,
        "ids:",
        e.v,
        e.w,
        "Translating: ",
        _chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clusterDb */ .ju.get(e.v),
        _chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clusterDb */ .ju.get(e.w)
      );
      if (mergeSelfLoops && edge.selfLoop) {
        ...
        await (0,_chunk_OSK3NFVY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .insertEdgeLabel */ .jP)(edgeLabels, labelEdge);
        edge.width = labelEdge.width;
        edge.height = labelEdge.height;
        edge.labelStyle = labelEdge.labelStyle;
        return;
      }
      await (0,_chunk_OSK3NFVY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .insertEdgeLabel */ .jP)(edgeLabels, edge);
    });
    await Promise.all(edgePromises);
  }, "processEdges");
  await processEdges();
  const { subGraphTitleTotalMargin } = (0,_chunk_GVQU2GXP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getSubGraphTitleMargins */ .Oi)(siteConfig);
  return {
    elem,
    graph,
...
var applyDagreLayoutResult = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K)((data4Layout, measuredLayout) => {
  ...
  (0,_chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .sortNodesByHierarchy */ .sc)(graph).forEach((nodeId) => {
...
var paintDagreLayoutCore = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K)(async ({
  ...
  let diff = 0;
  await Promise.all(
    (0,_chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .sortNodesByHierarchy */ .sc)(graph).map(async function(v) {
      const node = graph.node(v);
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .R.info(
      ...
      if (node?.clusterNode) {
        ...
        _chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clusterDb */ .ju.get(node.id).node = node;
        (0,_chunk_GVQU2GXP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .positionNode */ .U_)(node);
      } else {
        if (graph.children(v).length > 0) {
          _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_10__/* .log */ .R.info(
          ...
          await (0,_chunk_L3NEJ4N5_mjs__WEBPACK_IMPORTED_MODULE_1__/* .insertCluster */ .U)(clusters, node);
          _chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clusterDb */ .ju.get(node.id).node = node;
        } else {
  ...
  edgesToRender.forEach(function({ edge, start, end }) {
    ...
    const paths = (0,_chunk_OSK3NFVY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .insertEdge */ .Jo)(edgePaths, edge, _chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clusterDb */ .ju, diagramType, startNode, endNode, id);
    (0,_chunk_OSK3NFVY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .positionEdgeLabel */ .T_)(edge, paths);
  });
...
var prepareLayoutForDagre = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K)((data4Layout) => {
  ...
  (0,_chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .adjustClustersAndEdges */ .OS)(graph);
  return { graph };
...
var getDagrePaintNodes = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K)((_data4Layout, { measure }) => (0,_chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .sortNodesByHierarchy */ .sc)(measure.graph).map((nodeId) => measure.graph.node(nodeId)).filter(Boolean), "getDagrePaintNodes");
...
var render = (0,_chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .createCommonLayoutRenderer */ .xY)({
  prepareLayout: prepareLayoutForDagre,
  measureLayout: measureDagreLayout,
  runLayoutCore: runDagreLayoutCore,
  paintOptions: {
    clusterDb: _chunk_2E4U76K2_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clusterDb */ .ju,
