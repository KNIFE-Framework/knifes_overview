"use strict";
(globalThis["webpackChunkknife_preview"] = globalThis["webpackChunkknife_preview"] || []).push([[77430],{
...
function applyMarkerOffsets(points, edge) {
  ...
  const startOff = edge.arrowTypeStart && _chunk_OSK3NFVY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .markerOffsets */ .hq[edge.arrowTypeStart];
  if (startOff) {
    const a = points[0];
    const b = points[1];
  ...
  const endOff = edge.arrowTypeEnd && _chunk_OSK3NFVY_mjs__WEBPACK_IMPORTED_MODULE_2__/* .markerOffsets */ .hq[edge.arrowTypeEnd];
  if (endOff) {
