...
const removeDefaultStopWordFilter=[];const language=["en"];const searchIndexUrl="search-index{dir}.json?_=f77d0db3";const searchResultLimits=8;const fuzzyMatchingDistance=1;
