(globalThis["webpackChunkknife_preview"] = globalThis["webpackChunkknife_preview"] || []).push([[90540],{
...
// EXTERNAL MODULE: ./.docusaurus/@easyops-cn/docusaurus-search-local/default/generated-constants.js
var generated_constants = __webpack_require__(84809);
...
const extraTerms=[];for(const term of refinedTerms){if(term.length>2){for(let i=term.length-1;i>=0;i-=1){extraTerms.push(term.slice(0,i).concat(term.slice(i+1)));}}}const distance=Math.max(0,generated_constants/* fuzzyMatchingDistance */.Ho);return getDistanceMatrix(terms,distance).concat(getDistanceMatrix(extraTerms,distance));}function getQueriesMaybeTyping(terms,editDistance){return termsToQueries(terms,editDistance).concat(termsToQueries(// Ignore terms whose last token already has a trailing wildcard,
