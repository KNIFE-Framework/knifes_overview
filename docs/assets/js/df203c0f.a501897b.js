"use strict";
(globalThis["webpackChunkknife_preview"] = globalThis["webpackChunkknife_preview"] || []).push([[4279],{
...
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(74848);
;// ./node_modules/@docusaurus/theme-classic/lib/theme/DocTagDocListPage/index.js
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
function useNDocsTaggedPlural(){const{selectMessage}=usePluralForm();return count=>selectMessage(count,(0,Translate/* translate */.T)({id:'theme.docs.tagDocListPageTitle.nDocsTagged',description:'Pluralized label for "{count} docs tagged". Use as much plural forms (separated by "|") as your language support (see https://www.unicode.org/cldr/cldr-aux/charts/34/supplemental/language_plural_rules.html)',message:'One doc tagged|{count} docs tagged'},{count}));}function usePageTitle(props){const nDocsTaggedPlural=useNDocsTaggedPlural();return (0,Translate/* translate */.T)({id:'theme.docs.tagDocListPageTitle',description:'The title of the page for a docs tag',message:'{nDocsTagged} with "{tagName}"'},{nDocsTagged:nDocsTaggedPlural(props.tag.count),tagName:props.tag.label});}function DocItem({doc}){return/*#__PURE__*/(0,jsx_runtime.jsxs)("article",{className:"margin-vert--lg",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{to:doc.permalink,children:/*#__PURE__*/(0,jsx_runtime.jsx)(Heading/* default */.A,{as:"h2",children:doc.title})}),doc.description&&/*#__PURE__*/(0,jsx_runtime.jsx)("p",{children:doc.description})]});}function DocTagDocListPageMetadata({title,tag}){return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(metadataUtils/* PageMetadata */.be,{title:title,description:tag.description}),/*#__PURE__*/(0,jsx_runtime.jsx)(SearchMetadata/* default */.A,{tag:"doc_tag_doc_list"})]});}function DocTagDocListPageContent({tag,title}){return/*#__PURE__*/(0,jsx_runtime.jsx)(metadataUtils/* HtmlClassNameProvider */.e3,{className:(0,clsx/* default */.A)(ThemeClassNames/* ThemeClassNames */.G.page.docsTagDocListPage),children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"container margin-vert--lg",children:/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"row",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("main",{className:"col col--8 col--offset-2",children:[tag.unlisted&&/*#__PURE__*/(0,jsx_runtime.jsx)(Unlisted/* default */.A,{}),/*#__PURE__*/(0,jsx_runtime.jsxs)("header",{className:"margin-bottom--xl",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Heading/* default */.A,{as:"h1",children:title}),tag.description&&/*#__PURE__*/(0,jsx_runtime.jsx)("p",{children:tag.description}),/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{href:tag.allTagsPath,children:/*#__PURE__*/(0,jsx_runtime.jsx)(Translate/* default */.A,{id:"theme.tags.tagsPageLink",description:"The label of the link targeting the tag list page",children:"View all tags"})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("section",{className:"margin-vert--lg",children:tag.items.map(doc=>/*#__PURE__*/(0,jsx_runtime.jsx)(DocItem,{doc:doc},doc.id))})]})})})});}function DocTagDocListPage(props){const title=usePageTitle(props);return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(DocTagDocListPageMetadata,{...props,title:title}),/*#__PURE__*/(0,jsx_runtime.jsx)(DocTagDocListPageContent,{...props,title:title})]});}
