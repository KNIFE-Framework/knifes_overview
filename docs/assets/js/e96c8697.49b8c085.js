"use strict";
(globalThis["webpackChunkknife_preview"] = globalThis["webpackChunkknife_preview"] || []).push([[42082],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_en_help_index_md_e96_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-en-help-index-md-e96.json
const site_docs_en_help_index_md_e96_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"en/help/index","title":"Help – Ako používať túto dokumentáciu","description":"V tejto sekcii nájdeš praktické návody, ktoré sú súčasťou platformy – nie jednej konkrétnej triedy alebo inštancie.","source":"@site/docs/en/help/index.md","sourceDirName":"en/help","slug":"/en/help/","permalink":"/en/help/","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"title":"Help – Ako používať túto dokumentáciu"},"sidebar":"tutorialSidebar","previous":{"title":"📄 HOWTO – Vytvorenie novej Thesis šablóny","permalink":"/en/help/howto/new-thesis"},"next":{"title":"index","permalink":"/en/help/knifes/tools/"}}');
