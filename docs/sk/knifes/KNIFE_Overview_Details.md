...
**Technology**: Markdown, GitHub, AI-dialogue, Prozaická kultúra  
...
### K047 – KNIFE047 – 7S Cycle of Meaningful Knowledge
...
### K058 – AI Agent na monitoroavanie nákladov OpenGPT od počiatku komunikácie
...
### K076 – CAA- Context Aware Approach, CASY-Context Aware Systems, CASo-Context Aware Solution
...
### K077 – KNIFE047 – 7S Cycle of Meaningful Knowledge
...
**Context**: Nemám rád nátlakový marketing. Snažím sa budovať osobnú značku, dobrú reputáciu, dôveru bez nátlaku, na základu kvaluty a rešpektu.  
...
### K078 – Language as a Bridge (AI ako most medzi jazykmi)
...
**Context**: Typ: Praktický návod / Metodika
	•	Status: Draft
	•	Obsah:
	1.	Stručný recap LaaS (odkaz na K055).
	2.	Ako AI umožňuje mosty medzi jazykmi.
	3.	GitHub CI/CD príklady (preklady Markdown súborov).
	4.	LinkedIn posty – autenticita v materinskom jazyku vs. preklad pre globálne publikum.
	5.	Dopady pre študentov (písať autenticky, AI sa postará o zvyšok).
	•	Motto:
...
### K079 – Čo znamená slovo že je niečo idempotentné?

**Author**: Roman Kazička  
**Category**: Glossary  
**Status**: now  
**Type**: Vysvetlenie pojmu  
**Priority**: medium  
**Date**: 15.09.2029
...
### K080 – Docusaurus-vs-github-pages-package-json

**Author**: Roman Kazička  
**Category**: Explanation  
**Status**: now  
**Type**: Docusaurus vs. GitHub Pages. Architektúra  
**Priority**: medium  
**Date**: 17.09.2025

**Technology**: GitHub, React, Docusaurus  
...
### K081 – Transparentná -Stabilná infraštruktúra pre Sites
...
**Technology**: GitHUb, React, Docusaurus, Windows, Mac, Linux  
**Description**: Počas práce s GitHub a Pages je potrebné mať zladené prostredie na klientovi a na serveri. Lokál je závislý od OS, od verzí vývojových nástrojov. Ideálne by bolo, keby existovalo stabilné, opakovateľné prostredie pre vytvorenie lokálneho prostredia, bez ohľadu na operačný systém na klientovi – Windows, Mac, Linux.  
...
### K082 – Ako urobiť text v MD atraktívnejší (emoji)

**Author**: Roman Kazička  
**Category**: UserGuide pre Markdown  
**Status**: done md  
**Type**: Návod na riešenia  
**Priority**: low  
**Date**: 25.09.2025
...
### K083 – Aktualizácia komponentov pre Docusaurus
