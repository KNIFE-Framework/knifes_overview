...
### K001 – EA modelovanie a motivácia {#todo-k001}
...
---
### K002 – Git workflow pre EA modely {#todo-k002}
...
---
### K003 – LibreOffice + Python integrácia {#todo-k003}
...
---
### K004 – Docker pre študentov (K12) {#todo-k004}
...
---
### K005 – BaZi pre racionálne duše {#todo-k005}
...
---
### K006 – Tímová správa práv v Gitea {#todo-k006}
...
---
### K007 – Helper skript na obrázky v Markdown {#todo-k007}
...
---
### K008 – DCMM a DAO – hodnota leadershipu {#todo-k008}
...
---
### K009 – LinkedIn post engine – AI automatizácia {#todo-k009}
...
---
### K010 – OpenAI klient – vlastná AI komunikácia {#todo-k010}
...
---
### K011 – Main.xba šablóna pre LO Basic {#todo-k011}
...
---
### K012 – EA Workflow Add-In – pokročilé šablóny {#todo-k012}
...
---
### K013 – ReadOnlyControl v EA – Workflow Add-In {#todo-k013}
...
---
### K014 – Manažér knižníc pre LO Basic {#todo-k014}
...
**Context**: Nástroj pre správu LO knižíc – samostatne definovaný  
**Tags**:   
**Link**: [🔗](#todo-k014)

---
### K015 – LibreOffice Basic → Python migrácia {#todo-k015}
...
---
### K016 – Helper skript pre LO symbolic link {#todo-k016}
...
---
### K017 – AI-powered TERNO Planner {#todo-k017}
...
---
### K019 – BaZi výpočty – algoritmus, hodiny, kalendár {#todo-k019}
...
---
### K020 – LibreOffice ako komunitná platforma {#todo-k020}
...
---
### K021 – Princíp udržateľnosti v architektúre {#todo-k021}
...
---
### K022 – TERNO – terapeutické formy učenia {#todo-k022}
...
---
### K023 – AI interakcie – časová os a emócie {#todo-k023}
...
---
### K024 – OneNote ako zdroj metadát pre AI {#todo-k024}
...
---
### K025 – Kategorizácia TERNO podľa SDLC a 7D {#todo-k025}
...
---
### K026 – KNIFE Framework pre vývoj a učenie sa (LibreOffice, Python) {#todo-k026}
...
---
### K027 – Git For Dummies – Central Concepts {#todo-k027}
...
---
### K028 – Context Aware System Ontology, Approach {#todo-k028}
...
---
### K029 – Prostredie vývojové python pre LO {#todo-k029}
...
---
### K030 – Príbeh poznania SDLC {#todo-k030}
...
---
### K031 – „Document-as-Code“ framework {#todo-k031}
...
---
### K032 – „Enterprise Document-integrated SDLC“ {#todo-k032}
...
---
### K033 – Smalltalk ako nástroj flowu a kontextu {#todo-k033}
...
---
### K033 – Smalltalk ako nástroj flowu a kontextu {#todo-k033-2}
...
---
### K036 – Pracovno, finančný ekosystém {#todo-k036}
...
---
### K037 – Context Aware Solutions / paradigma, solution {#todo-k037}
...
---
### K038 – Ako si vyrobit automaticke nastavovanie SSL {#todo-k038}
...
---
### K039 – Sementicke a kontextove vyhladavanie nad GitHUB {#todo-k039}
...
---
### K040 – Migracia Joomla -->GitHUB MkDocs {#todo-k040}
...
---
### K041 – GitHUB Education Framework {#todo-k041}
...
---
### K042 – SinglePageApplication – Webabased desktop app {#todo-k042}
...
---
### K043 – Kontrola odpovedé študentov pomocou API na AI {#todo-k043}
...
---
### K044 – OneDrive backup to external disk on QNAP {#todo-k044}
...
### K052 – GitHub LMS Framework (Implementácia) {#todo-k052}
...
### K053 – Framework for Project Management in GitHUB {#todo-k053}
...
---
### K054 – Docusaurus Advanced Deployment Pipeline {#todo-k054}
...
---
### K055 – Ako obnoviť stav z minulosti? {#todo-k055}
...
### K056 – Central Panel for GIT – SDLC Git Management {#todo-k056}
...
---
### K057 – Kontrola referencií a broken link checker {#todo-k057}
...
---
### K058 – Obnova minulých verzií súborov/folderov – Sandbox workflow {#todo-k058}
